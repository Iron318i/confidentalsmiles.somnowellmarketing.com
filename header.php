                ...
                <div class="margin">
                    <ul class="innser-bar1">
                        ...
                        <?php } elseif (is_tax('treatmentcategory')) { ?>
                            <li><a href="<?php echo site_url('/'); ?>"> Home </a></li>
                            <li> /</li>
                            <li><a href="<?php echo get_permalink(12); ?>"> Treatments </a></li>
                            <li> /</li>
                            <li> <?php single_cat_title(); ?></li>
                        <?php } elseif (is_tax('gallerycategory')) { ?>
                            <li><a href="<?php echo site_url('/'); ?>"> Home </a></li>
                            <li> /</li>
                            <li><a href="<?php echo get_permalink(13); ?>"> Smile Gallery </a></li>
                            <li> /</li>
                            <li> <?php single_cat_title(); ?></li>
                        ...
                        <?php } elseif (is_singular('treatment')) { ?>
                            ...
                            <li><a href="<?php echo get_permalink(12); ?>"> Treatments </a></li>
                            <li> /</li>
                            <li><?php $category = get_the_term_list($post->ID, 'treatmentcategory', '', ', ');
                        ...
                        <?php } elseif (is_singular('team')) { ?>
                            <li><a href="<?php echo site_url('/'); ?>"> Home </a></li>
                            <li> /</li>
                            <li><a href="<?php echo get_permalink(11); ?>"> Meet The Team </a></li>
                            <li> /</li>
                            <li> <?php the_title(); ?> </li>
                        <?php } elseif (is_single()) { ?>
                            ...
                            <li><a href="<?php echo get_permalink(7); ?>">Blog </a></li>
                            <li> /</li>
                            <li><?php $category = get_the_term_list($post->ID, 'category', '', ', ');
                                $explode = explode(",", $category);
                                if (!empty($explode)) {
                                    echo $explode[0];
                                } ?></li>
